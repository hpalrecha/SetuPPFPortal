...
export const DEFAULT_TEMPLATES: Record<string, NotifTemplate> = {
  ...
  job_card_scheduled: {
    ...
    emailActive: true, whatsappTemplateName: 'job_card_scheduled', whatsappLanguage: 'en_US', whatsappActive: true,
  },
  job_card_completed_customer: {
    ...
    emailActive: true, whatsappTemplateName: 'job_card_completed', whatsappLanguage: 'en', whatsappActive: true,
  },
  job_card_rework: {
    ...
    emailActive: true, whatsappTemplateName: 'job_card_rework', whatsappLanguage: 'en_US', whatsappActive: true,
  },
  job_card_rescheduled: {
    eventType: 'job_card_rescheduled', label: 'Rescheduled',
    emailSubject: 'Job rescheduled (requested by {party})',
    emailBody: 'Job card {jobId} for {vehicle} has been rescheduled to {when}, requested by the {party} side. Reason: {reason}',
    emailActive: true, whatsappTemplateName: 'job_card_rescheduled', whatsappLanguage: 'en_US', whatsappActive: true,
  },
  job_card_approved: {
  ...
  job_arrival_check: {
    ...
    emailActive: true, whatsappTemplateName: 'job_arrival_check', whatsappLanguage: 'en_US', whatsappActive: true,
  },
  job_car_ready_check: {
    ...
    emailActive: true, whatsappTemplateName: 'job_car_ready_check', whatsappLanguage: 'en_US', whatsappActive: true,
  },
  job_at_time_check: {
    ...
    emailActive: true, whatsappTemplateName: 'job_at_time_check', whatsappLanguage: 'en_US', whatsappActive: true,
  },
  job_checkup_due: {
    ...
    emailActive: true, whatsappTemplateName: 'job_checkup_due', whatsappLanguage: 'en_US', whatsappActive: true,
  },
};
