...
function Router() {
  return (
    <Switch>
      ...
      <Route
        path="/work-orders"
        component={() => <ProtectedRoute component={WorkOrdersPage} />}
      />
      <Route
        path="/work-orders/:id"
        component={() => <ProtectedRoute component={WorkOrdersPage} />}
      ...
      <Route
        path="/payouts"
        component={() => <ProtectedRoute component={PayoutsPage} />}
      />
      <Route
        path="/allocations"
        component={() => <ProtectedRoute component={AllocationsPage} />}
      />
      <Route
        path="/pricing"
        component={() => <ProtectedRoute component={PricingPage} />}
      />
      <Route
        path="/commissions"
        component={() => <ProtectedRoute component={CommissionsPage} />}
      />
      <Route
        path="/payout-settlement"
        component={() => <ProtectedRoute component={PayoutSettlementPage} />}
      />
      <Route
        path="/oems"
        component={() => <ProtectedRoute component={OEMsPage} />}
      />
      <Route
        path="/dealerships"
        component={() => <ProtectedRoute component={DealershipsPage} />}
      />
      <Route
        path="/showrooms"
        component={() => <ProtectedRoute component={ShowroomsPage} />}
      />
      <Route
        path="/sales-persons"
        component={() => <ProtectedRoute component={SalesPersonsPage} />}
      />
      <Route
        path="/vehicles"
        component={() => <ProtectedRoute component={VehiclesPage} />}
      />
      <Route
        path="/services"
        component={() => <ProtectedRoute component={ServicesPage} />}
      />
      <Route
