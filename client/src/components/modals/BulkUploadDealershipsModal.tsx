...
export function BulkUploadDealershipsModal({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await apiRequest('POST', '/api/dealerships/bulk-upload', formData);
      ...
      if (result.success > 0 && result.failed === 0) {
        ...
        toast({
          ...
          description: `${result.success} dealership(s) created, ${result.failed} failed. Check details below.`,
          variant: "default",
        });
        onSuccess();
